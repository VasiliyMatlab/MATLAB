...
% Программа для вычисления КЧХ фильтра Бесселя n-ого порядка (не имеет
% нулей)

n = 5;                                               % порядок фильтра Бесселя
[z,p,k] = besselap(n);                               % вычисление нулей, полюсов и общего коэф. усиления
